...
1. **Verify directory structure:**
   ...
   - If unable to create, tell user: "❌ Cannot create PRD directory. Please manually create: prds/"
...
4. Check if `prds/{proposed-name}.md` already exists
...
Save the completed PRD to: `prds/{assigned-name}.md` with this exact structure:
...
1. Confirm: "✅ PRD created: prds/{assigned-name}.md"
2. Show brief summary of what was captured
3. Suggest next step: "Ready to create implementation epic? Run: /ccpm:prd-parse {assigned-name}"
