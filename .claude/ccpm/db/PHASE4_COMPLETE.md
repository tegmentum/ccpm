...
$ .claude/scripts/in-progress-db.sh
🚀 In Progress Tasks
====================
Epic: user-auth-backend
  ⚙️  #2 - API endpoints
...
- `.claude/scripts/blocked-db.sh` (70 lines)
- `.claude/scripts/in-progress-db.sh` (55 lines)
...
- `.claude/scripts/epic-show-db.sh` (193 lines)
- `.claude/scripts/standup-db.sh` (167 lines)
- `.claude/scripts/task-start-db.sh` (120 lines)
- `.claude/scripts/task-close-db.sh` (137 lines)
- `.claude/scripts/prd-status-db.sh` (193 lines)

### New Files (Session 3 - Remaining Commands)
- `.claude/scripts/task-show-db.sh` (169 lines)
- `.claude/scripts/next-db.sh` (115 lines)
- `.claude/scripts/epic-new-db.sh` (57 lines)
- `.claude/scripts/epic-close-db.sh` (92 lines)
- `.claude/scripts/prd-new-db.sh` (48 lines)
- `.claude/scripts/epic-decompose-db.sh` (135 lines)
...
- `.claude/scripts/epic-show-db.sh`
- `.claude/scripts/standup-db.sh`
- `.claude/scripts/task-start-db.sh`
- `.claude/scripts/task-close-db.sh`
- `.claude/scripts/prd-status-db.sh`

### Session 3 - All Remaining Commands ✅
- `.claude/scripts/task-show-db.sh` - Display task details with dependencies
- `.claude/scripts/next-db.sh` - Show ready-to-start tasks
- `.claude/scripts/epic-new-db.sh` - Create new epic
- `.claude/scripts/epic-close-db.sh` - Close an epic
- `.claude/scripts/prd-new-db.sh` - Create new PRD
- `.claude/scripts/epic-decompose-db.sh` - Decompose epic into tasks
