...
echo "  /pm:epic-start <name>     - Setup worktree for epic work"
echo "  /pm:epic-parallel [name]  - Launch parallel agents for tasks"
echo ""
echo "📝 Task Commands"
echo "  /pm:task-add [epic] <name> [opts] - Add task (to epic or backlog)"
echo "  /pm:task-start <epic> <num>       - Start working on task"
echo "  /pm:task-close <epic> <num>       - Complete task"
echo "  /pm:task-show <epic> <num>        - Show task details"
echo ""
echo "📝 Issue Commands"
