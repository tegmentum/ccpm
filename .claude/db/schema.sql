...
-- Maps to: epics/{epic_name}/{task_number}.md
CREATE TABLE tasks (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
...
-- Progress Updates
-- Maps to: epics/{epic}/updates/{issue}/progress.md
...
-- Maps to: epics/{epic}/updates/{issue}/stream-{X}.md
...
-- Issue Analysis
-- Maps to: epics/{epic}/updates/{issue}/{issue}-analysis.md
