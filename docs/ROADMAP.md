...
- `.claude/scripts/status-db.sh` - Database-backed status command
- `.claude/scripts/prd-list-db.sh` - Database-backed PRD listing
- `.claude/scripts/epic-list-db.sh` - Database-backed epic listing
- `.claude/scripts/next-db.sh` - Database-backed ready task finder
...
- `db/sync/github-resolve.sh` - Resolve conflicts
  ...
  - Dry-run mode
- `.claude/scripts/sync.sh` - Main command wrapper
...
- [x] `pm:issue-sync` - Removed (replaced by `pm:github-sync`)
- [x] `pm:epic-sync` - Removed (replaced by `pm:github-sync`)

### 4.2 Remove/Deprecate GitHub-Dependent Commands
- [x] Remove `pm:issue-sync` (replaced by `pm:github-sync`)
- [x] Remove `pm:epic-sync` (replaced by `pm:github-sync`)
- [x] Update all references to use `pm:github-sync`
