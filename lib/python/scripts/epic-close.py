...
def main():
    """Main entry point."""
    if len(sys.argv) < 2:
        print_error("Usage: pm epic-close <epic-name>")
        print()
        print("Example: pm epic-close user-auth-backend")
        sys.exit(1)
    ...
    print()
    print("Next steps:")
    print("  • View PRD status: pm prd-status")
    print("  • View standup: pm standup")
